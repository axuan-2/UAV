...
const float Control_Unit[18][20]=
{
  ...
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,2.50  ,1.80  ,0  ,0 , 1000,  1 ,  1 ,  1 },//Pitch_Gyro;偏航角速度
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,30  ,0  ,0 , 100,  5.00   ,0.00  ,0.00  ,0  ,0 , 500,   1 ,  1 ,  1 },//Roll_Angle;横滚角
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,500 ,0  ,0 , 300,  0.75   ,2.50  ,1.80  ,0  ,0 , 1000,  1 ,  1 ,  1 },//Roll_Gyro;横滚角速度
...
#else //1.00
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,200 ,0  ,0 ,100 ,  1.10     ,0.000   ,0    ,0  ,0 ,600,  1 ,  1 ,  1 },//High_Position;海拔高度位置   //1.00
  ...
  */
  ...
  /*************光流位置、速度控制器****************/
	{1  ,1 ,0 ,0 ,0 ,0 , 0 ,200   ,15  ,0 ,15,  0.25  ,0.00   ,0    ,0   ,0 ,45,   1 ,  1 ,  1 },//光流水平位置控制器 //p:0.25
	{1  ,1 ,0 ,0 ,0 ,0 , 0 ,100   ,30  ,0 ,200, 4.5  ,0.05   ,0.0  ,0   ,0 ,450 , 1 ,  1 ,  1 },//光流水平速度控制器    p:4.5  i:0.05
		
  {1  ,1 ,0 ,0 ,0 ,0 , 0 ,50    ,30  ,0 ,100, 1.0  ,0.00   ,1.0 ,0   ,0 ,300  , 1 ,  1 ,  1 },//SDK位置控制器   2.5  150
};
